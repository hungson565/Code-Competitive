...
void solve(int i) {
  ...
  int a = min(data[0][0], min(data[1][0], data[2][0]));
  int b = min(data[0][1], min(data[1][1], data[2][1]));
  int c = min(data[0][2], min(data[1][2], data[2][2]));
  int d = min(data[0][3], min(data[1][3], data[2][3]));
